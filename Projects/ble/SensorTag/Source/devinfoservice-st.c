/**************************************************************************************************
  ...
  Description:    This file contains the Device Information service. It is
                  specially adapted for the Sensor Tag.
...
static const uint8 devInfoFirmwareRev[] = "1.5 ("__DATE__")";
